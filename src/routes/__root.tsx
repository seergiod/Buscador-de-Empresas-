...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LeadMapper — Encuentra negocios sin web" },
      { name: "description", content: "Encuentra negocios locales sin presencia online y conviértete en su socio digital." },
      { name: "author", content: "LeadMapper" },
      { property: "og:title", content: "LeadMapper — Encuentra negocios sin web" },
